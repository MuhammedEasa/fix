...
import third_banner from '../../../../public/images/third-banner.jpg';
import third_banner_mobile from '../../../../public/images/third-banner-mobile.jpg';
...
const FinancialFuture = () => {
  ...
  return (
    <Wrapper>
      ...
      <Banner>
        {isMobile ? (
          <Image src={third_banner_mobile} alt="future_banner" fill />
        ) : (
          <Image src={third_banner} alt="future_banner" fill />
        )}
      </Banner>
    </Wrapper>
  );
