...
import second_banner from '../../../../public/images/second-banner.jpg';
import second_banner_mobile from '../../../../public/images/second-banner-mobile.jpg';
    ...
    <Wrapper>
      <Inner>
        ...
        <BannerCtn>
          ...
          >
            {isMobile ? (
              <Image src={second_banner_mobile} alt="banner_img" fill />
            ) : (
              <Image src={second_banner} alt="banner_img" fill />
            )}
          </Div>
        </BannerCtn>
        <Edges>
